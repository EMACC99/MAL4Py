...
class MalAnime:
    ...
    def get_seasonal(
        ...
        return self.__query._get(
            self.__slug_type + "/season/%i/%s" % (year, season), payload
        )
...
class MalUser:
    ...
    def get_mangalist(
        ...
        return self.__query._get(
            self.__slug_type + "/%s/mangalist" % (user_id), payload
        )
    ...
    def get_animelist(
        ...
        return self.__query._get(
            self.__slug_type + "/%s/animelist" % (user_id), payload
        )
